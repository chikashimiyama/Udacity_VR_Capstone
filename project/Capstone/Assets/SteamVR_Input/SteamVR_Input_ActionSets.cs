...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Input
    {
        ...
        public static Valve.VR.SteamVR_Input_ActionSet_domainF domainF;
        
        public static void Dynamic_InitializeActionSets()
        {
            SteamVR_Input._default.Initialize();
            SteamVR_Input.domainF.Initialize();
        }
        ...
        public static void Dynamic_InitializeInstanceActionSets()
        {
            ...
            Valve.VR.SteamVR_Input.domainF = ((SteamVR_Input_ActionSet_domainF)(SteamVR_Input_References.GetActionSet("domainF")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[]
            {
                    Valve.VR.SteamVR_Input._default,
                    Valve.VR.SteamVR_Input.domainF};
        }
    }
}
